...
<head>
    ...
    <link href="<?php echo base_url()?>assets/bower_components/bootstrap/dist/css/service_style.css" rel="stylesheet" type="text/css">
                    ...
                    <div class="col-sm-4 col-md-2" style="margin-top: 6px; padding: 0px;">
                            ...
                            <div class="col-sm-6 col-md-12" style="padding:0px;">
                                ...
                                <div class="col-md-9" style="padding: 0px;line-height: 2;margin-left:-50px;">
                                    <a style="<?php if(isset($this->session->acc_log1)){ echo 'margin-left:19px;';}?>" href="<?php if(isset($this->session->acc_log1)){ echo base_url("user_account/account_info");}else{ echo base_url("registerControl");}?>"><?php if($this->session->acc_log1){ echo "Hi ".$acc_head->acc_name; }else{ echo "<i class='fa fa-user' aria-hidden='true' style='color: #33a3dd;'></i> "."Register";} ?></a>
                                </div>
                                </div>
