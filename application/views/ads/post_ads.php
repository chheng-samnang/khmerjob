					...
					<div class="row">
						<div class="col-md-6">
		      				<div class="form-group">
		      					...
		      					<select name="ddlAdsLoc" id="ddlAdsLoc" class="form-control">
		      						<option value="">Choose one</option>
		      						<?php if(isset($ads_setup)){foreach($ads_setup as $ads_setup1){?>
		      							<option value="<?php echo $ads_setup1->rate_det_id;?>" <?php echo set_select("ddlAdsLoc",$ads_setup1->rate_det_id)?> <?php if(isset($Top) && $Top->rate_det_type==$ads_setup1->rate_det_type){echo 'disabled';}?>><?php echo $ads_setup1->ads_setup2;?></option>
		      						<?php }}?>		      								      								      					
		      					</select>
		      				</div>			        					        						        						        	
			        	</div>
			        	<div class="col-md-6">
				    		<label class="control-label">Posting Date</label>
		      				<div class="input-group datetimepicker">
		      					<?php echo form_input(array("name"=>"txtPostingDate","id"=>"txtPostingDate","value"=>set_value("txtPostingDate"),"class"=>"form-control datetimepicker","placeholder"=>"Click on Posting date"));?>		      											      					                                         		                                          
					...
					<div class="row">						
						<div class="col-md-6">											
				    		<label class="control-label">Advertisement URL</label>
	                          <div class="form-group">
	                            <?php echo form_input(array("name"=>"txtAdsURL","id"=>"txtAdsURL","value"=>set_value("txtAdsURL"),"class"=>"form-control"));?>		      					
	                          </div>							    	
						</div>
						<div class="col-md-6">											
