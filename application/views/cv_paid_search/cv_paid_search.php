...
<?php echo form_open("cv_paid_search_c/add/$url","id='form' name='form'");?>
		        ...
		        <!---=====End Error validation=====-->
		        	...
		        	<div class="row">
			        	...
			        	<div class="col-md-6">
		      				<div class="form-group">
		      					...
		      					<select name="ddlCvpsDuration" id="ddlCvpsDuration" class="form-control">
		      						<option value="-1">Choose one</option>
		      						<?php if(isset($cps_setup)){foreach($cps_setup as $cps_setup1){?>
		      							<option value="<?php echo $cps_setup1->key_code;?>" <?php echo set_select("ddlCpsDuration",$cps_setup1->key_code)?>><?php echo $cps_setup1->cps_setup2;?></option>
		      						<?php }}?>
		      					</select>
		      				</div>
			        	</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<?php echo form_input("txtCusName",set_value("txtCusName",$cus_info->acc_name),"class='form-control' id='txtCusName'") ?>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">Phone</label>
								<?php echo form_input("txtPhone",set_value("txtPhone",$cus_info->acc_phone),"class='form-control' id='txtPhone'") ?>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<?php echo form_input("txtAddr",set_value("txtAddr",$cus_info->acc_addr),"class='form-control' id='txtAddr'") ?>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">Email</label>
								<?php echo form_input("txtEmail",set_value("txtEmail",$cus_info->acc_email),"class='form-control' id='txtEmail'") ?>
							</div>
						</div>
					</div>
					...
					<div class="row"><!--==== button action ====-->
						<div class="col-md-12">
							...
							<input type="button" name="btnDelete" id="btnDelete" class="btn btn-default" value="Delete">
