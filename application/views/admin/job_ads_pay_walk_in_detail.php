      ...
      <?php echo form_open(base_url("admin/pay_walk_in_c/addPay_walk"),"id='form' name='form'");?>
        <div class="row" ng-app="myApp" ng-controller="myCtrl" ng-cloak>
            <div class="col-lg-7"><!--==left==-->                     
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          <table class="table table-border">
                            ...
                            <?php  $sum_price=0;$sum_discount=0; if($val){foreach($val as $val1){?>
                              <tr>
                                <td><?php 
                                if(isset($val1->job_code)){echo $val1->job_code;}else{echo $val1->ads_code;}?></td>
                                <td><?php echo $val1->price;?></td>
                                <td><?php echo $val1->duration.' days';?></td>
                                <td><?php
                                  if(isset($val1->job_2post_discount))
                                    { 
                                      echo $val1->rate_det_type=="Premium"?($premium->premium>=2?$val1->job_2post_discount:0)."%":($standard->standard>=2?$val1->job_2post_discount:0)."%";
                                    }
                                    else{
                                      echo $val1->rate_det_type=="Top"?($top->top>=2?$val1->ads_discount:0)."%":($side->side>=2?$val1->ads_discount:0)."%";
                                    }?>      
                                <td><?php echo $val1->rate_det_type;?></td>
                                <?php if(isset($val1->job_2post_discount))
                                      {
                                        $sum_discount +=$val1->rate_det_type=="Premium"?($premium->premium>=2?$val1->job_2post_discount:0):($standard->standard>=2?$val1->job_2post_discount:0);
                                      }else
                                      {
                                       $sum_discount+=$val1->rate_det_type=="Top"?($top->top>=2?$val1->ads_discount:0)."%":($side->side>=2?$val1->ads_discount:0)."%";
                                      }
                                ?>
                                <?php $sum_price+=$val1->price;?>
                              </tr>
                            <?php }}?>
                          </table>
                ...
                <input type="hidden" ng-init="txtAccId='<?php echo $val1->acc_id;?>'" ng-model="txtAccId" value="<?php $val1->acc_id;?>" name="txtAccId">
                    </div>    
                </div>            
            </div><!--==left==-->
            <div class="col-lg-5"><!--==left==-->                     
              ...
              <!--==== end msg error =====-->
                ...
                <!--== form ==-->
                    <!-- start hidden texbox -->
                    <input type="hidden" value="<?php echo $val1->acc_id;?>" name="txtAccId" id="txtAccId">
                       ...
                       <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <input type="number" ng-model="txtCash" id="txtCash"  name="txtCash" class="form-control" return false" required="required">
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="form-group">
