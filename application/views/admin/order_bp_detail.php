...
?>
	...
	<div id="page-wrapper">
		<div class="container_fluid" style="margin-top:40px;">
			<div class="row">
				<div class="col-lg-12">				
					<h1 class="page-header">Form Bundle Package Detail</h1>									
						<!--== account Informaion==-->
								 <div class="col-lg-4">
	                    ...
	                    <!--== Job Informaion==-->
								<div class="col-lg-4">
								 	<div class="panel panel-primary">
								 		<div class="panel-heading">
								 			<h3 class="panel-title">Bundle Package Information</h3>
								 		</div>
								 		<div class="panel-body">								 			
											<p><b>Bundle Package ID: </b><?php echo $detail->bp_code;?></p>
											<p><b>Duration: </b><?php echo $detail->key_code.' Days';?></p>
			                               	<p><b>Price: </b><?php echo $detail->key_data.' $';?></p>																						
											<p><b>Posting Date: </b><?php echo date("d/m/Y",strtotime($detail->date_from));?></p>											
											<p><b>Bundle Package Status: </b><?php echo $detail->bp_status;?></p>
											<p><b>Bundle Package Action: </b><?php echo $detail->bp_action;?></p>																																																																														                                                              	                                	                                                               	                                
	                            		</div>
								 	</div>
	                            </div>
	                    <!--== End Job Informaion==-->
