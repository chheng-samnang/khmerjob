    ...
    <div class="row">
        <div class="panel panel-default">
            ...
            <div class="table-responsive">
               <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td><?php echo $value->duration;?> Day<?php if($value->duration >1){ echo "s";} ?></td>
                  <td><?php echo $value->ads_size;?></td>
                  <td><?php echo $value->price;?> $</td>
                  <td><?php echo $value->ads_discount;?> %</td>
                  <td><?php echo $value->rate_det_type=="Top"?$value->key_code.' Days':$value->key_code.'hours'?></td>
                </tr> 
                <?php 
                  }
                ?>
          ...
          <div class="row">
            ...
            <a href="<?php echo base_url("ads_c/post_ads");?>" class="btn btn-success pull-right">Post your advertise</a>
