...
class Account_c extends CI_Controller
{
	...
	{			
		...
		$option2= array(''=>'Choose one','individual'=>'Individual','company'=>'Company','recruitment_agency'=>'Recruitment agency','government'=>'Government');																																		
		$data['ctrl'] = $this->createCtrl($row="",$option,$option1,$option2,$this->account_code());		
	...
	{		
		if($id!="")
		{
			...
			{	
				...
				$option1= array('1'=>'Enable','0'=>'Disable');
				$option2= array(''=>'Choose one','individual'=>'Individual','company'=>'Company','recruitment_agency'=>'Recruitment agency','government'=>'Government');																																		
				$data['ctrl'] = $this->createCtrl1($row,$option,$option1,$option2,$this->account_code());			
	...
	public function createCtrl($row="",$option,$option1,$option2,$acc_code="")
	...
	public function createCtrl1($row="",$option,$option1,$option2,$acc_code="")
