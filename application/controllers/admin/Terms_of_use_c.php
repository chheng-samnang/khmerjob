<?php
class Terms_of_use_c extends CI_Controller
{
	var $pageHeader,$page_redirect;	
	public function __construct()
	{
		parent::__construct();
		$this->pageHeader='Terms of Use';
		$this->page_redirect="admin/Terms_of_use_c";								
	...
	{		
		if($id!="")
		{
			$row=$this->terms_of_use_m->index($id);			
			if($row==TRUE)
			{																										
	...
	{		
		...
		{						
			if($this->validation()==TRUE)
			{	
				$row=$this->terms_of_use_m->edit($id);	
				if($row==TRUE)
	            {	                		                	
					redirect("{$this->page_redirect}/");	
	            }																												 																				            	                	                                												
	...
	public function delete($id="")
	{
		if($id!="")
		{
			$row=$this->terms_of_use_m->delete($id);
